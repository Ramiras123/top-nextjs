		...
		<div className={styles['hh']}>
			...
			<Card className={styles['salary']}>
				<div>
					...
					<div className={styles['state_salary_value']}>{juniorSalary}</div>
				...
				<div>
					...
					<div className={styles['state_salary_value']}>{middleSalary}</div>
					<div className={styles['state_rate']}>
						<RateIcon className={styles.filled} />
						<RateIcon className={styles.filled} />
						<RateIcon />
				...
				<div>
					...
					<div className={styles['state_salary_value']}>{seniorSalary}</div>
					<div className={styles['state_rate']}>
						<RateIcon className={styles.filled} />
						<RateIcon className={styles.filled} />
						<RateIcon className={styles.filled} />
